...
const PostListItemDark = ({ id, title, body, sub }: Post) => {
    return (
        <li class="mt-6 w-full list-none p-[0.15rem] flex bg-purple-800 rounded-[0.5rem] text-white shadow-lg border-2 hover:border-accent hover:bg-gradient-to-r hover:from-purple-800 hover:to-purple-400 transition-all">
